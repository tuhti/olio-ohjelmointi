...
class Sankari:
    ...
    :type nimi: str
    :ivar voima: sankarin voima, arvotaan
    :type voima: int
    :ivar kesto: sankarin kesto, arvotaan
    :type kesto: int
    ...
    NIMITAVUT = ("Jo", "Ja", "Ju", "Je", "Ji", "Ka", "Ki", "Ko", "Ke", "Ku", "La", "Li", "Lo", "Le", "Lu", "Ma", "Mi",
                 "Mo", "Me", "Mu", "Na", "Ni", "No", "Ne", "Nu", "Oo", "Pa", "Pi", "Po", "Pe", "Pu", "Ra", "Ri", "Ro",
                 "Re", "Ru", "Sa", "Si", "So", "Se", "Su", "Ta", "Ti", "To", "Te", "Tu", "Va", "Vi", "Vo", "Ve", "Vu",
                 "Yi", "Yo")

    def __init__(self):
        """Konstruktori."""
        self.nimi = self._arvo_sanat(self.NIMITAVUT, 2, "")
        self.voima = random.randint(5, 10)
        self.kesto = random.randint(5, 10)
    ...
    def arvo_hurraus(self):
        ...
        :rtype: str
        """
        return self._arvo_sanat(("Eläköön", "Hyvä me", "Kuolema peikolle", "Jihuu", "Yesss", "Voitto on meidän","Vihdoinkin"), 8, " ", 0.7)
